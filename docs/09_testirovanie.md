...
| `test_tutorial.py` | 8 | видеообучение: ролики на диске, отправка одним сообщением с текстом и клавиатурой экранов 1/3/4, повторная отправка исключена, fallback в текст при ошибке |
...
* **Экраны**: текст и кнопки каждого экрана, сохранение контекста, переходы,
  ...
  обучающие MP4-ролики приходят одним сообщением с текстом и клавиатурой
  экранов 1, 3 и 4 (шаги обучения нарисованы внутри ролика); Экран 13 — выбор
  категории рейтинга, подмена возраста анкеты в подборке и сброс.
